$(document).ready(function () {
    ...
    var reviewTable = $('#product-datatable').DataTable({
        ajax: {
            headers: {
                'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')
            },
            type: 'GET',
            url: get_product_datatable
        },
        language: {
            paginate: {
                next: '>>',
    ...
    $(document).on('click', '.statusUpdate', function() {
        ...
        Swal.fire({
            ...
            text: 'Are you sure want to ACTIVE this Product' ,
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            Swal.fire({
                ...
                text: "Are you sure want to InActive this Product",
                icon:'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',

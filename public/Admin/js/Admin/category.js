$(document).ready(function () {
    ...
    var reviewTable = $('#category-datatable').DataTable({
        ajax: {
            headers: {
                'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')
            },
            type: 'GET',
            url: get_category_datatable
        },
        language: {
            paginate: {
                next: '>>',
    ...
    $(document).on('click', '.statusUpdate', function() {
        ...
        Swal.fire({
            ...
            text: 'Are you sure want to ACTIVE this Product Category' ,
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            Swal.fire({
                title: 'Product Category InActive',
                text: "Are you sure want to InActive this Product Category",
                icon:'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',

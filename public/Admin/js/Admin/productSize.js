$(document).ready(function () {
    ...
    var reviewTable = $('#product-category-datatable').DataTable({
        ajax: {
            headers: {
                'X-CSRF-Token': $('meta[name="csrf-token"]').attr('content')
            },
            type: 'GET',
            url: get_product_size_datatable
        },
        language: {
            paginate: {
                next: '>>',
    ...
    $(document).on('click', '.delete', function () {
        ...
        Swal.fire({
            ...
            text: 'Are you sure you want to delete this Product Size ?',
            icon: 'warning',
    ...
    $(document).on('click', '.statusUpdate', function() {
        ...
        Swal.fire({
            title: 'Product Size ACTIVE',
            text: 'Are you sure want to ACTIVE this Product Size' ,
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            Swal.fire({
                title: 'Product Size InActive',
                text: "Are you sure want to InActive this Product Size",
                icon:'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
    ...
    function ajaxCallForChangeStatus(_this, status, opportunity_id) {
        ...
        $.ajax({
            ...
            dataType: "json",
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            url: product_size_status_update,
